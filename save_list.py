...
tempF = open("/home/hyewon/2018CRA/allReview1.csv", 'a', encoding='utf-8', newline='')
...
for i in data[33] :
    pyear = api.get_info(i[0], i[1])['prdtYear']
    movie_name = api.get_info(i[0], i[1])['movieNm']
    Rlist = mr.crawlReview(movie_name, i[1], pyear, maxPage=500)
    for j in Rlist :
